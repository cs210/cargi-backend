...
var api = {
    get: function(request, response, next) {
        ...
        .then(function(results) {
            ...
            var query2 = {sql: 'SELECT DISTINCT c.name as name FROM contacts c, event_history e, event_contacts ec where e.user_id = @user_id and e.id = ec.event_id and c.id = ec.contact_id',
            parameters: [
